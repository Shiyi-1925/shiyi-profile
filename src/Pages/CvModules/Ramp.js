            ...
            <div className="site-layout-background" id="ramp" style={{ padding: 24, textAlign: 'left' }}>
              <Typography>
                ...
                <Row gutter={[16,16]} justify="center">
                  <Col span={16}>
                    <Card cover={<img src="图3.2 协同运动控制策略思路.jpg"/>}>
                ...
                <Row gutter={[16,16]} justify="center">
                  <Col span={16}>
                    <Card cover={<img src="虚拟跟驰模型示意图.gif"/>}>
                ...
                <Row gutter={[16,16]} justify="center">
                  <Col span={10}>
                    <Card cover={<img src="图3.17a 过渡函数、虚拟车跟驰模型对VMR运动状态的修正.fig.jpg"/>}>
                      <Meta title="不同方案下目标车辆的速度图线" style={{textAlign:"center"}} />
                    </Card>
                  </Col>
                  <Col span={10}>
                    <Card cover={<img src="图3.17b 过渡函数、虚拟车跟驰模型对VMR运动状态的修正.fig.jpg"/>}>
                ...
                <Row justify="center">
                  <Col span={16}>
                    <Card cover={<img src="图3.18 支付函数等高线图.jpg"/>}>
